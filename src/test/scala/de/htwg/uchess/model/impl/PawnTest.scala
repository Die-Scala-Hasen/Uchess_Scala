...
class PawnTest extends WordSpec with Matchers {
  ...
  "A Pawn" should {
    "return a valid moveSet" when {
      ...
      "it includes two Points froward, if the straight Point is empty and the right diagonal Point includes a enemy figure  " in {
        val gameFieldBuilder = Map.newBuilder[Point,Piece]
        val currentPoint = Point(3, 6)
      ...
      "it includes two Points froward, if the straight Point is empty and the left diagonal Point includes a enemy figure  " in {
        val gameFieldBuilder = Map.newBuilder[Point,Piece]
        val currentPoint = Point(3, 6)
